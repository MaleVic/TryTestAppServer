...
import com.example.gamesmannna.trytestappserver.Model.Category;
import com.example.gamesmannna.trytestappserver.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Меню Управления");
    ...
    private void showDialog() {
        ...
        alertDialog.setMessage("Пожалуйста, добавьте информацию о категории");
        ...
        alertDialog.setPositiveButton("ДА", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (newCategory != null)
                {
                    ...
                    Snackbar.make(drawer,"Новая категория "+newCategory.getName()+" была добавлена",Snackbar.LENGTH_SHORT)
                            .show();
